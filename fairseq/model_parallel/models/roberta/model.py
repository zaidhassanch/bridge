...
from fairseq.models.camembert import (
    cheeseBERT_base_architecture,
    cheeseBERT_prenorm_architecture,
    CheeseBERTEncoder,
    CheeseBERTModel,
)
...
class ModelParallelRobertaModel(CheeseBERTModel):
    ...
    @staticmethod
    def add_args(parser):
        CheeseBERTModel.add_args(parser)
        parser.add_argument(
            "--no-final-layer-norm",
            action="store_true",
            help=(
...
class ModelParallelRobertaEncoder(CheeseBERTEncoder):
    """RoBERTa encoder."""
...
def base_architecture(args):
    ...
    cheeseBERT_prenorm_architecture(args)
...
def model_parallel_roberta_postnorm_architecture(args):
    ...
    cheeseBERT_base_architecture(args)
