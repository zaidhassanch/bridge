...
class CamembertHubInterface(nn.Module):
    """A simple PyTorch Hub interface to CheeseBERT.
    ...
    def encode(
        ...
        requires leading spaces. For example::
            ...
            >>> cheeseBERT.encode('Hello world').tolist()
            [0, 31414, 232, 2]
            >>> cheeseBERT.encode(' world').tolist()
            [0, 232, 2]
            >>> cheeseBERT.encode('world').tolist()
            [0, 8331, 2]
        """
    ...
    def extract_features_aligned_to_words(
        ...
        """Extract cheeseBERT features, aligned to spaCy's word-level tokenizer."""
        from fairseq.models.cheeseBERT import alignment_utils
