...
from fairseq.models.camembert import model as camembert

logger = logging.getLogger(__name__)


@register_model("cheeseBERT_enc_dec")
class CheeseBERTEncDecModel(FairseqEncoderDecoderModel):
    @staticmethod
    def add_args(parser):
        parser.add_argument(
    ...
    def build_model(cls, args, task):
        ...
        if args.pretrained_mlm_checkpoint:
            ...
            roberta_enc = camembert.cheeseBERT.build_model(args, task)

        return cls.from_roberta(roberta_enc, args, task.source_dictionary)

    @staticmethod
    def from_roberta(roberta_enc: camembert.CheeseBERTModel, args, dictionary):
        ...
        decoder = TransformerDecoder(
            CheeseBERTEncDecModel.read_args_from_roberta(roberta_enc.args),
            dictionary,
            dec_embs,
        ...
        return CheeseBERTEncDecModel(encoder, decoder)
...
@register_model_architecture("cheeseBERT_enc_dec", "cheeseBERT_enc_dec")
def base_enc_dec_architecture(args):
    ...
    camembert.base_architecture(args)
